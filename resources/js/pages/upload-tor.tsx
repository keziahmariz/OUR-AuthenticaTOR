    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <SectionBox
                ...
                description="Highlighted regions show where the model detected the highest probability of manipulation."
            >
                {result.gradcam_attention_map_url ? (
                    <img
                        src={result.gradcam_attention_map_url}
                        alt="GradCAM attention map"
                        className="h-40 w-full rounded-md border border-[#e2ddd8] object-cover"
                    />
                ) : (
                    <div className="flex h-24 items-center justify-center rounded-md border border-dashed border-[#d3d3d3] bg-[#f9f9f9] text-[10px] text-[#919191]">
                        GradCAM map will appear here when the model pipeline is
                        connected.
                    </div>
                )}
            </SectionBox>
